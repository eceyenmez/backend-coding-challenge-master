...
class FeaturesControllerTest {
    ...
    @Test
    fun `should get image of given featureID`() {
        given()
    ...
    @Test
    fun `should return not found when featureID does not exists`() {
        given()
                .get("/features/39c2f29e-c0f8-4a39-a98b-deed547d6aee/quicklook")
                .then()
                .statusCode(404)
    }

    @Test
    fun `should return bad request when featureID is wrong`() {
        given()
                .get("/features/lokisan/quicklook")
                .then()
                .statusCode(400)
    }
}
